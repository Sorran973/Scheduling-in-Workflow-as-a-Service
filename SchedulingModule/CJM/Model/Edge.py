...
class Edge:  # Data transfer
    ...
    def __init__(self, node_from, node_to, files, vm_perf, data_transfer_channel_speed):
        self.id = Edge.id
        ...
        self.transfer_time = round_up(self.transfer_size / data_transfer_channel_speed)
