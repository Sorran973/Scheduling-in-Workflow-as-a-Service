...
from AllocationModule.EPSM.AllocationEPSM import AllocationEPSM_Batch_BestFit
from AllocationModule.EPSM.AllocationNewVM import AllocationNewVM
from AllocationModule.EPSM.AllocationEPSM_VMA import AllocationEPSM_Batch_VMA
...
if __name__ == '__main__':
    ...
    epsm_batch_bestfit = AllocationNewVM(VMA_CRITERIA, vm_types, deepcopy(tasks))
    time = 0
    ...
    ftl_counter = 0
    asap_counter = 0
    for i, cost in enumerate(epsm_batch_bestfit.workflow_costs):
    ...
    print("EPSM dif = " + str(epsm_batch_bestfit.different_workflow_reuse_vm_counter))
